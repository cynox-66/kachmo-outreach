...
import { isUrl, phoneKey } from '../contact/provenance.js';

/**
 * Contradictory or dangerous lead states. Every persistence adapter must refuse to write a database containing
 * any of these, so an impossible state cannot be persisted by any code path.
 */
