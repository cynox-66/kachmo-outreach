...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **016** | **Wonderland** | `hello@wonderland.studio` | Arch-1 | **SENT** | Motion & 3D WebGL overflow · HISTORICAL SEND (webmail-sends-2026-09-12): actually sent 2026-09-12 14:33 UTC via WEBMAIL/MANUAL, not dispatched by Titan; evidence: studios mailbox Sent folder, read-only IMAP investigation 2026-09-18, IMAP UID 34; reconciled 2026-09-18 by Dev Jaiswal |
| **017** | **Helder** | `studio@helder.design` | Arch-1 | **SENT** | Bespoke typography in React · HISTORICAL SEND (webmail-sends-2026-09-12): actually sent 2026-09-12 14:33 UTC via WEBMAIL/MANUAL, not dispatched by Titan; evidence: studios mailbox Sent folder, read-only IMAP investigation 2026-09-18, IMAP UID 35; reconciled 2026-09-18 by Dev Jaiswal |
| **018** | **A New Day Studio** | `hello@anewday.studio` | Arch-1 | **SENT** | White-label campaign engineering · HISTORICAL SEND (webmail-sends-2026-09-12): actually sent 2026-09-12 14:32 UTC via WEBMAIL/MANUAL, not dispatched by Titan; evidence: studios mailbox Sent folder, read-only IMAP investigation 2026-09-18, IMAP UID 16; reconciled 2026-09-18 by Dev Jaiswal |
| **020** | **studio sesenta** | `hi@studiosesenta.com` | Arch-1 | **SENT** | European brand dev partnership · HISTORICAL SEND (webmail-sends-2026-09-12): actually sent 2026-09-12 14:33 UTC via WEBMAIL/MANUAL, not dispatched by Titan; evidence: studios mailbox Sent folder, read-only IMAP investigation 2026-09-18, IMAP UID 32; reconciled 2026-09-18 by Dev Jaiswal |
| **021** | **Granyon** | `hello@granyon.com` | Arch-1 | **SENT** | Copenhagen values-led production dev · HISTORICAL SEND (webmail-sends-2026-09-12): actually sent 2026-09-12 14:32 UTC via WEBMAIL/MANUAL, not dispatched by Titan; evidence: studios mailbox Sent folder, read-only IMAP investigation 2026-09-18, IMAP UID 17; reconciled 2026-09-18 by Dev Jaiswal |
| **022** | **Side Perspectives** | `hello@sideperspectives.com` | Arch-1 | **SENT** | Discrete brand dev overflow · HISTORICAL SEND (webmail-sends-2026-09-12): actually sent 2026-09-12 14:33 UTC via WEBMAIL/MANUAL, not dispatched by Titan; evidence: studios mailbox Sent folder, read-only IMAP investigation 2026-09-18, IMAP UID 33; reconciled 2026-09-18 by Dev Jaiswal |
| **030** | **Thonik** | `info@thonik.nl` | Arch-1 | **SENT** | Dutch experimental motion · HISTORICAL SEND (webmail-sends-2026-09-12): actually sent 2026-09-12 14:33 UTC via WEBMAIL/MANUAL, not dispatched by Titan; evidence: studios mailbox Sent folder, read-only IMAP investigation 2026-09-18, IMAP UID 29; reconciled 2026-09-18 by Dev Jaiswal |
| **033** | **Moss** | `founders@moss.dev` | Arch-2 | **SENT** | Dev tools hero interactive revamp · HISTORICAL SEND (webmail-sends-2026-09-12): actually sent 2026-09-12 14:33 UTC via WEBMAIL/MANUAL, not dispatched by Titan; evidence: studios mailbox Sent folder, read-only IMAP investigation 2026-09-18, IMAP UID 30; reconciled 2026-09-18 by Dev Jaiswal |
| **035** | **Poth Labs** | `matthew@pothlabs.com` | Arch-2 | **SENT** | Founder pitch hero conversion · HISTORICAL SEND (webmail-sends-2026-09-12): actually sent 2026-09-12 14:33 UTC via WEBMAIL/MANUAL, not dispatched by Titan; evidence: studios mailbox Sent folder, read-only IMAP investigation 2026-09-18, IMAP UID 31; reconciled 2026-09-18 by Dev Jaiswal |
| **042** | **Dome** | `support@domeapi.com` | Arch-2 | **DISQUALIFIED** | ❌ Gate 2 violation: `support@` inbox. Remove from Titan Drafts. · EXTERNAL MANUAL SEND (webmail-sends-2026-09-12): emailed 2026-09-12 14:33 UTC via WEBMAIL/MANUAL outside the approved Titan path despite this disqualification; remains disqualified, never approved or dispatched by Titan; evidence: studios mailbox Sent folder, read-only IMAP investigation 2026-09-18, IMAP UID 27; reconciled 2026-09-18 by Dev Jaiswal |
| **049** | **Semble** | `info@sembleai.com` | Arch-2 | **SENT** | AI product interactive narrative · HISTORICAL SEND (webmail-sends-2026-09-12): actually sent 2026-09-12 14:33 UTC via WEBMAIL/MANUAL, not dispatched by Titan; evidence: studios mailbox Sent folder, read-only IMAP investigation 2026-09-18, IMAP UID 28; reconciled 2026-09-18 by Dev Jaiswal |
| **052** | **The Context Company** | `founders@thecontextcompany.com` | Arch-2 | **SENT** | Enterprise clarity sprint · HISTORICAL SEND (webmail-sends-2026-09-12): actually sent 2026-09-12 14:33 UTC via WEBMAIL/MANUAL, not dispatched by Titan; evidence: studios mailbox Sent folder, read-only IMAP investigation 2026-09-18, IMAP UID 25; reconciled 2026-09-18 by Dev Jaiswal |
| **061** | **Holloway Li** | `studio@hollowayli.com` | Arch-3 | **SENT** | Architectural spatial digital folio · HISTORICAL SEND (webmail-sends-2026-09-12): actually sent 2026-09-12 14:33 UTC via WEBMAIL/MANUAL, not dispatched by Titan; evidence: studios mailbox Sent folder, read-only IMAP investigation 2026-09-18, IMAP UID 26; reconciled 2026-09-18 by Dev Jaiswal |
| **069** | **Jono Pandolfi Designs** | `care@jonopandolfi.com` | Arch-3 | **DISQUALIFIED** | ❌ Gate 2 violation: `care@` inbox. Remove from Titan Drafts. |
| **073** | **Cosmedocs Aesthetic** | `info@cosmedocs.com` | Arch-4 | **SENT** | High-ticket consultation booking UX · HISTORICAL SEND (webmail-sends-2026-09-12): actually sent 2026-09-12 14:32 UTC via WEBMAIL/MANUAL, not dispatched by Titan; evidence: studios mailbox Sent folder, read-only IMAP investigation 2026-09-18, IMAP UID 23; reconciled 2026-09-18 by Dev Jaiswal |
| **074** | **Luxury Aesthetics** | `info@luxuryaestheticclinic.com` | Arch-4 | **SENT** | Clinic appointment conversion lift · HISTORICAL SEND (webmail-sends-2026-09-12): actually sent 2026-09-12 14:33 UTC via WEBMAIL/MANUAL, not dispatched by Titan; evidence: studios mailbox Sent folder, read-only IMAP investigation 2026-09-18, IMAP UID 24; reconciled 2026-09-18 by Dev Jaiswal |
| **078** | **Acacia Gardens** | `info@acacia-gardens.co.uk` | Arch-4 | **SENT** | High-ticket landscape quote UX · HISTORICAL SEND (webmail-sends-2026-09-12): actually sent 2026-09-12 14:32 UTC via WEBMAIL/MANUAL, not dispatched by Titan; evidence: studios mailbox Sent folder, read-only IMAP investigation 2026-09-18, IMAP UID 20; reconciled 2026-09-18 by Dev Jaiswal |
| **079** | **Perry Guillot Inc.** | `p@guillotinc.com` | Arch-4 | **SENT** | Hamptons estate landscape portfolio · HISTORICAL SEND (webmail-sends-2026-09-12): actually sent 2026-09-12 14:32 UTC via WEBMAIL/MANUAL, not dispatched by Titan; evidence: studios mailbox Sent folder, read-only IMAP investigation 2026-09-18, IMAP UID 21; reconciled 2026-09-18 by Dev Jaiswal |
| **080** | **Laurel Group** | `info@thelaurelgroup.net` | Arch-4 | **SENT** | Design/build consult path polish · HISTORICAL SEND (webmail-sends-2026-09-12): actually sent 2026-09-12 14:32 UTC via WEBMAIL/MANUAL, not dispatched by Titan; evidence: studios mailbox Sent folder, read-only IMAP investigation 2026-09-18, IMAP UID 18; reconciled 2026-09-18 by Dev Jaiswal |
| **083** | **Insight Legal** | `info@insightlegal.co.in` | Arch-4 | **SENT** | Dispute practice digital trust overhaul · HISTORICAL SEND (webmail-sends-2026-09-12): actually sent 2026-09-12 14:32 UTC via WEBMAIL/MANUAL, not dispatched by Titan; evidence: studios mailbox Sent folder, read-only IMAP investigation 2026-09-18, IMAP UID 19; reconciled 2026-09-18 by Dev Jaiswal |
...
| # | Target Name | Recipient Contact | Archetype | Sent Date | Follow-up Due | Current Status | Thread Notes & Conversion Outcome |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **101** | **Spin** | `studio@spin.co.uk` | Arch-1 (White-Label Agency) | 2026-09-23 | 2026-09-26 | **SENT** | Unit Editions & AIR Studios typography craft. Subject: dev overflow for Spin?. Scheduled for Tue ~9:00 AM (Europe/London). |
| **102** | **OMSE** | `hello@omse.co` | Arch-1 (White-Label Agency) | 2026-09-23 | 2026-09-26 | **SENT** | Kinetic typography for Printworks London. Subject: kinetic web builds for OMSE?. Scheduled for Tue ~9:00 AM (Europe/London). |
| **103** | **A Practice for Everyday Life** | `n@apracticeforeverydaylife.com` | Arch-1 (White-Label Agency) | 2026-09-23 | 2026-09-26 | **SENT** | Tate & Bauhaus Dessau institutional typography. Subject: interactive digital builds for APFEL?. Scheduled for Tue ~9:00 AM (Europe/London). |
| **104** | **Accept & Proceed** | `partnership@acceptandproceed.com` | Arch-1 (White-Label Agency) | 2026-09-23 | 2026-09-26 | **SENT** | Nike & NASA brand installations. Subject: creative dev for Accept & Proceed?. Scheduled for Tue ~9:00 AM (Europe/London). |
| **105** | **NIMU Agency** | `nieke@nimuagency.com` | Arch-1 (White-Label Agency) | 2026-09-23 | 2026-09-26 | **SENT** | Editorial art direction & tactile luxury craft. Subject: dev overflow for NIMU Agency?. Scheduled for Tue ~9:00 AM (Europe/Amsterdam). |
