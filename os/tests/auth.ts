...
group('7. Audit service');
{
  ...
  const dated = redact({ at: '2026-09-12T14:32Z', day: '2026-09-12', ts: '2026-09-12T14:32:05.000Z', mixed: 'sent 2026-09-12 to +44 20 7946 0000', fake: '+2026-09-12345' }) as Record<string, string>;
  assert(dated.at === '2026-09-12T14:32Z' && dated.day === '2026-09-12' && dated.ts === '2026-09-12T14:32:05.000Z', 'ISO-8601 dates in audit metadata survive redaction', dated);
  assert(dated.mixed === 'sent 2026-09-12 to [phone]', 'a phone next to a date is still masked', dated.mixed);
  assert(dated.fake === '[phone]', 'a phone number that merely starts like a date is still masked', dated.fake);
